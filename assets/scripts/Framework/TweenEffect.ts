...
export default class TweenEffect extends cc.Component {
    ...
    /** 线性效果 */
    private _line() {
        this._tw.by(this.time, { position: this.toPos }, { easing: TweenEffect.getEase(this.easeType) })
        if (this.isReverse) this._tw.by(this.time, { position: this.toPos.neg() }, { easing: TweenEffect.getEase(this.easeType) })
    }
    /** 旋转效果 */
    private _angle() {
        this._tw.by(this.time, { angle: this.num }, { easing: TweenEffect.getEase(this.easeType) })
        if (this.isReverse) this._tw.by(this.time, { angle: -this.num }, { easing: TweenEffect.getEase(this.easeType) })
    }
    /** 透明效果 */
    private _opacity() {
        this._tw.by(this.time, { opacity: this.num }, { easing: TweenEffect.getEase(this.easeType) })
        if (this.isReverse) this._tw.by(this.time, { opacity: -this.num }, { easing: TweenEffect.getEase(this.easeType) })
    }
    /** 缩放效果 */
    private _scale() {
        this._tw.by(this.time, { scale: this.num }, { easing: TweenEffect.getEase(this.easeType) })
        if (this.isReverse) this._tw.by(this.time, { scale: -this.num }, { easing: TweenEffect.getEase(this.easeType) })
    }
    /** 偏斜效果 */
    private _skewY() {
        this._tw.by(this.time, { skewY: this.num }, { easing: TweenEffect.getEase(this.easeType) })
        if (this.isReverse) this._tw.by(this.time, { skewY: -this.num }, { easing: TweenEffect.getEase(this.easeType) })
    }
    /** 晃动效果 */
    private _shake() {
        this._tw
            .by(this.time, { angle: this.num }, { easing: TweenEffect.getEase(this.easeType) })
            .by(this.time * 2, { angle: -2 * this.num }, { easing: TweenEffect.getEase(this.easeType) })
            .by(this.time, { angle: this.num }, { easing: TweenEffect.getEase(this.easeType) })
    }
    /** 翻转效果 */
    private _flip() {
        this._tw
            .to(this.time, { scaleX: -this.node.scaleX }, { easing: TweenEffect.getEase(this.easeType) })
            .to(this.time, { scaleX: this.node.scaleX }, { easing: TweenEffect.getEase(this.easeType) })
    }
    ...
    public static panel_mask_opacity(node: cc.Node, callback?: Function) {
        ...
        node.opacity = 0;
        cc.tween(node).to(0.2, { opacity: opacityBack }).call(() => { callback && callback(); }).start();
    }

    /** 移动Y轴_打开 */
    public static panel_open_moveY(node: cc.Node, callback?: Function) {
        node.y += 1000;
        cc.tween(node).to(0.5, { y: node.y - 1000 }, { easing: "sineOut" }).call(() => { callback && callback(); }).start();
    }
    /** 移动Y轴_关闭 */
    public static panel_close_moveY(node: cc.Node, callback?: Function) {
        cc.tween(node).to(0.5, { y: node.y + 1000 }, { easing: "sineIn" }).call(() => { callback && callback(); }).start();
    }

    /** 缩放Y轴_打开 */
    public static panel_open_scaleY(node: cc.Node, callback?: Function) {
        node.scaleY = 0;
        cc.tween(node).to(0.5, { scaleY: 1 }, { easing: "sineOut" }).call(() => { callback && callback(); }).start();
    }
    /** 缩放Y轴_关闭 */
    public static panel_close_scaleY(node: cc.Node, callback?: Function) {
        cc.tween(node).to(0.5, { scaleY: 0 }, { easing: "sineIn" }).call(() => { callback && callback(); }).start();
    }

    /** 整体缩放_打开 */
    public static panel_open_scale(node: cc.Node, callback?: Function) {
        node.scale = 0;
        cc.tween(node).to(0.5, { scale: 1 }, { easing: "sineOut" }).call(() => { callback && callback(); }).start();
    }
    /** 整体缩放_关闭 */
    public static panel_close_scale(node: cc.Node, callback?: Function) {
        cc.tween(node).to(0.5, { scale: 0 }, { easing: "sineIn" }).call(() => { callback && callback(); }).start();
    }
    ...
    public static panel_open_opacity_scale(node: cc.Node, callback?: Function) {
        node.opacity = 0;
        node.scale = 1.5;
        cc.tween(node).to(0.5, { opacity: 255, scale: 1 }, { easing: "fade" }).call(() => { callback && callback(); }).start();
    }
    /** 透明度缩放_关闭 */
    public static panel_close_opacity_scale(node: cc.Node, callback?: Function) {
        cc.tween(node).to(0.5, { opacity: 0, scale: 2 }, { easing: "fade" }).call(() => { callback && callback(); }).start();
    }
